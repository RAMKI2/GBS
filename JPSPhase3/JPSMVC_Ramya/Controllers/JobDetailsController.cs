...
namespace JPSMVC_Ramya.Controllers
{
    ...
    public class JobDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Employer,Address,PhoneNumber,EmailId,SkillsRequired,Qualification,Location,Salary,NoOfVaccancies")] JobDetail jobDetail)
        {
